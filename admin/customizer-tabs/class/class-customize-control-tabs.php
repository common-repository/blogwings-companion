 ...
 * @access public
 */
class Blogwings_Companion_Control_Tabs extends WP_Customize_Control {
	/**
	 * Blogwings_Companion_Control_Tabs constructor.
	 *
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'blogwings-companion-tabs-control-script', BLOGWINGS_COMPANION_PLUGIN_URL . '/admin/customizer-tabs/js/script.js', array( 'jquery'), '1.0.0', true );
		wp_enqueue_style( 'blogwings-companion-tabs-control-style', BLOGWINGS_COMPANION_PLUGIN_URL .'/admin/customizer-tabs/css/style.css', array(), '1.0.0' );
	    }
	/**
	 * Enqueue the partials handler script that works synchronously with the blogwings-companion-tabs-control-script
	 */
	public function partials_helper_script_enqueue() {
		wp_enqueue_script( 'blogwings-companion-tabs-addon-script', BLOGWINGS_COMPANION_PLUGIN_URL .'/admin/customizer-tabs/js/customizer-addon-script.js',array('jquery'), '1.0.0' );
	}
	/**
