 ...
 * @since 1.1.38
 */
function blogwc_get_standard_fonts(){
	return apply_filters(
		'blogwc_standard_fonts_array', array(
 ...
 * @since 1.1.38
 */
function blogwc_enqueue_google_font( $font ) {
	...
	$subsets        = '';
	$get_subsets    = get_theme_mod( 'blogwc_font_subsets', array( 'latin' ) );
	...
	// Enqueue style
	wp_enqueue_style( 'blogwc-google-font-' . $handle, $url, array(), false );
}
