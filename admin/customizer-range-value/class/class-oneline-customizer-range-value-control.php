 ...
 * @access public
 */
class Blogwings_Companion_Range_Value_Control extends WP_Customize_Control {
	...
	/**
	 * Blogwings_Companion_Range_Value_Control constructor.
	 *
	...
	public function enqueue() {
		wp_enqueue_script( 'customizer-range-value-control', BLOGWINGS_COMPANION_PLUGIN_URL . 'admin/customizer-range-value/js/customizer-range-value-control.js', array( 'jquery', 'customize-base' ), '1.0.0', true );
		wp_enqueue_style( 'customizer-range-value-control', BLOGWINGS_COMPANION_PLUGIN_URL . 'admin/customizer-range-value/css/customizer-range-value-control.css', array(), '1.0.0' );
	}
 ...
 * @since 1.1.38
 */
function blogwc_sanitize_range_value( $input ) {
	if ( blogwc_is_json( $input ) ) {
