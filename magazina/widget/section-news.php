<?php
  ...
  * Add Widget
  */
class Blogwings_Companion_Section_News extends WP_Widget {

    function __construct() {
        $widget_ops = array('classname' => 'magazina-section-news',
            'description' => __('Display breaking news slider','blogwings-companion'));
        parent::__construct('magazina-section-news', __('Add Magazina : News Slider','blogwings-companion'), $widget_ops);
    }
    ...
    function widget($args, $instance) {
        ...
        // widget content
        echo $before_widget;
        $title = isset($instance['title'])?$instance['title']:__('Breaking News','blogwings-companion');
...
<?php
    ...
    function form($instance) {
      $title = isset($instance['title']) ? esc_attr($instance['title']) : __('Breaking News','blogwings-companion');  
      $fcate = isset($instance['fcate']) ? absint($instance['fcate']) : 0;
      $fcount = isset($instance['fcount']) ? absint($instance['fcount']) : 4;
      $news_bg_color = isset($instance['news_bg_color']) ? $instance['news_bg_color'] :"#0e0e0e";
      $news_tle_color = isset($instance['news_tle_color']) ? $instance['news_tle_color'] :"#fff";
...
<div class="clearfix"></div>
   <p>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('fcate'); ?>"><?php _e('Select Specific Option To Display Post','blogwings-companion'); ?></label>
        <select name="<?php echo $this->get_field_name('fcate'); ?>" ><?php echo $foption; ?></select>
    </p>
   <p><label for="<?php echo $this->get_field_id( 'news_bg_color' ); ?>" style="display:block;"><?php _e( 'Background Color:','blogwings-companion' ); ?></label> 
    ...
    <p><label for="<?php echo $this->get_field_id( 'news_tle_color' ); ?>" style="display:block;"><?php _e( 'Tilte Color:','blogwings-companion' ); ?></label> 
    ...
    <p><label for="<?php echo $this->get_field_id( 'news_post_tle_color' ); ?>" style="display:block;"><?php _e( 'Post Tilte Color:','blogwings-companion' ); ?></label> 
    ...
    <p><label for="<?php echo $this->get_field_id( 'news_post_tme_bgcolor' ); ?>" style="display:block;"><?php _e( 'Post Date Background Color :','blogwings-companion' ); ?></label> 
    ...
    <p><label for="<?php echo $this->get_field_id( 'news_post_tme_color' ); ?>" style="display:block;"><?php _e( 'Post Date Color :','blogwings-companion' ); ?></label> 
