...
class Blogwings_Companion_Aboutme extends WP_Widget {
    function __construct() {
        $widget_ops = array('classname' => 'magazina-about-me','description' => __('Display Author image with description, link and font awesome icons','blogwings-companion'));
        parent::__construct('magazina-about-me-widget', __('Add Magazina : About Me','blogwings-companion'), $widget_ops);
    }
...
<?php if($author_img_uri != ''){ ?>
 <a href="<?php echo $readlink; ?>"><div class="thumb"><img src="<?php echo esc_url($author_img_uri); ?>" /></div></a>
 <?php } ?>
 <p><?php echo $text; ?></p>
...
<p>
        <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title','blogwings-companion'); ?></label>
...
<p>
        <label for="<?php echo $this->get_field_id('author_img_uri'); ?>"><?php _e('Author Image','blogwings-companion'); ?></label>
                <?php
    ...
    <p>
        <label for="<?php echo $this->get_field_id('text'); ?>"><?php _e('About Me Description','blogwings-companion'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('readtxt'); ?>"><?php _e('Read More Text','blogwings-companion'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('readlink'); ?>"><?php _e('Link','blogwings-companion'); ?></label>
    ...
    <p>
        <label style="padding-bottom: 5px; padding-top:0px;font-size: 12px;font-style: italic;"><?php _e('Go to this link for <a target="_blank" href="//fontawesome.io/icons/">Fontawesome icons</a> and copy the class of icon that you need & paste it below.','blogwings-companion'); ?></label>
        <label for="<?php echo $this->get_field_id('icon1'); ?>"><?php _e('Fontawesome Social Icon-1','blogwings-companion'); ?></label>
        ...
        <label for="<?php echo $this->get_field_id('linkicon1'); ?>"><?php _e('Social Icon Link','blogwings-companion'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('icon2'); ?>"><?php _e('Fontawesome Social Icon-2','blogwings-companion'); ?></label>
        <input type="text" class="widefat" name="<?php echo $this->get_field_name('icon2'); ?>" id="<?php echo $this->get_field_id('icon2'); ?>" value="<?php  if(isset($instance["icon2"])){ echo $instance['icon2']; } ?>" style="margin-top:5px;">
         <label for="<?php echo $this->get_field_id('linkicon2'); ?>"><?php _e('Social Icon Link','blogwings-companion'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('icon3'); ?>"><?php _e('Fontawesome Social Icon-3','blogwings-companion'); ?></label>
        ...
        <label for="<?php echo $this->get_field_id('linkicon3'); ?>"><?php _e('Social Icon Link','blogwings-companion'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('icon4'); ?>"><?php _e('Fontawesome Social Icon-4','blogwings-companion'); ?></label>
        <input type="text" class="widefat" name="<?php echo $this->get_field_name('icon4'); ?>" id="<?php echo $this->get_field_id('icon4'); ?>" value="<?php  if(isset($instance["icon4"])){ echo $instance['icon4']; } ?>" style="margin-top:5px;">
         <label for="<?php echo $this->get_field_id('linkicon4'); ?>"><?php _e('Social Icon Link','blogwings-companion'); ?></label>
