 ...
 */
class Blogwings_Companion_Social extends WP_Widget {
    /** constructor */
    function __construct() {
        $widget_ops = array(
            'classname' => 'magazina-socialth-widget',
            'description' => __('Display Social Icon in Sidebar','blogwings-companion'));
        parent::__construct('magazina-social-widget', __('Add Magazina : Social Widget','blogwings-companion'), $widget_ops);
    }
...
<p><label for="<?php echo $this->get_field_id('title'); ?>">
    <?php _e('Title','blogwings-companion'); ?></label>
        <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" /></p>
<p><label for="<?php echo $this->get_field_id('icon_one_link'); ?>"><?php _e('Facebook URL','blogwings-companion'); ?></label>
        ...
        <!-- II  --> 
<p><label for="<?php echo $this->get_field_id('icon_second_link'); ?>"><?php _e('Google URL','blogwings-companion'); ?></label>
...
<!-- III --> 
<p><label for="<?php echo $this->get_field_id('icon_second_link'); ?>"><?php _e('Twitter URL','blogwings-companion'); ?></label>
 ...
 <!-- four --> 
<p><label for="<?php echo $this->get_field_id('icon_four_link'); ?>"><?php _e('Pinterest URL','blogwings-companion'); ?></label>
...
<!-- FIVE -->
<p><label for="<?php echo $this->get_field_id('icon_five_link'); ?>"><?php _e('Linkedin URL','blogwings-companion'); ?></label>
...
<!-- SIX -->
<p><label for="<?php echo $this->get_field_id('icon_six_link'); ?>"><?php _e('Youtube URL','blogwings-companion'); ?></label>
