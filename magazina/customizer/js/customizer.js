...
// Magzine widget 
    // Magzine widget 
    wp.customize.section( 'sidebar-widgets-magazine-widget' ).panel('elanzalite_magzine');
    wp.customize.section( 'sidebar-widgets-magazine-widget' ).priority('5');
    wp.customize.section( 'sidebar-widgets-magazine-sidebar-widget' ).panel('elanzalite_magzine');
    wp.customize.section( 'sidebar-widgets-magazine-sidebar-widget' ).priority('6');
    wp.customize.control( 'magazina_magzine_layout' ).section( 'sidebar-widgets-magazine-sidebar-widget' );
    wp.customize.section( 'sidebar-widgets-magazine-widget-second' ).panel('elanzalite_magzine');
    wp.customize.section( 'sidebar-widgets-magazine-widget-second' ).priority('7');
    wp.customize.section( 'sidebar-widgets-magazine-sidebar-widget-second' ).panel('elanzalite_magzine');
    wp.customize.section( 'sidebar-widgets-magazine-sidebar-widget-second' ).priority('8');
    wp.customize.control( 'magazina_magzine_layout_second' ).section( 'sidebar-widgets-magazine-sidebar-widget-second' );
    wp.customize.section( 'sidebar-widgets-magazine-widget-third' ).panel('elanzalite_magzine');
    wp.customize.section( 'sidebar-widgets-magazine-widget-third' ).priority('9');
