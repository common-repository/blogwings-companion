...
function blogwings_companion_magazina_custom_style(){ 
$custom_css='';
...
$ftr_wgt_txt_color    = get_theme_mod('ftr_wgt_txt_color','#666');
$ftr_wgt_link_color   = get_theme_mod('ftr_wgt_link_color','#666');
// header-setting
...
$custom_css .= ".top-container{background:$top_hd_bg_color;}.header-wrap-top .top-date{color:$top_date_clr;}.header-wrap-top .top-menu .top li a{color:$top_menu_clr;} .header-wrap-top .top-social-icon li a{color:$social_icon_color;} 
...
.top-searchfrom i,.header-wrap-top a#pull{color:{$top_icon_clr};}
...
a:hover,.post-title h2:hover,a.more-link,.widget .tagcloud a:hover,.footer-wrapper .social-icon li a:hover,li a:hover,.content .post-content .read-more a{color:{$theme_color};}
...
.footer-wrapper .footer-copyright .copyright a,.footer-wrapper .footer-copyright .copyright{color:{$copy_txt_color};}
.footer-wrapper .footer-copyright{background:{$ftr_cpybg_color};}
.footer-wrapper .social-icon li a{color:{$social_icon_color};}
.footer-wrapper .widget li a,.footer-wrapper .widget a{color:{$ftr_wgt_link_color};}
.footer-wrapper .widget p{color:{$ftr_wgt_txt_color};}
.footer-wrapper .widget li a:hover{color:{$theme_color};}
...
.flex-slider.button-one .read-more.read-more-slider a:hover{
    -webkit-box-shadow: 0 14px 26px -12px " .blogwings_companion_magazina_hex2rgba($slider_btn_brd_hvr_color, 0.42);
     $custom_css.=", 0 4px 23px 0 " .blogwings_companion_magazina_hex2rgba($slider_btn_brd_hvr_color, 0.12); 
     $custom_css.=", 0 8px 10px -5px " .blogwings_companion_magazina_hex2rgba($slider_btn_brd_hvr_color, 0.2);
     $custom_css.=";box-shadow: 0 14px 26px -12px " .blogwings_companion_magazina_hex2rgba($slider_btn_brd_hvr_color, 0.42); 
    $custom_css.=", 0 4px 23px 0 " .blogwings_companion_magazina_hex2rgba($slider_btn_brd_hvr_color, 0.12); 
    $custom_css.=", 0 8px 10px -5px " .blogwings_companion_magazina_hex2rgba($slider_btn_brd_hvr_color, 0.12);
   $custom_css.="}";
/***********************************/
// body-typography
/***********************************/
...
blogwings_companion_enqueue_google_font($elanzalite_body_font);
$custom_css.="body,p{ 
...
blogwings_companion_enqueue_google_font($elanzalite_body_font_h1);
...
blogwings_companion_enqueue_google_font($elanzalite_body_font_h2);
...
blogwings_companion_enqueue_google_font($elanzalite_body_font_h3);
$custom_css.="h3{ 
...
blogwings_companion_enqueue_google_font($elanzalite_body_font_h4);
...
blogwings_companion_enqueue_google_font($elanzalite_body_font_h5);
$custom_css.="h5{ 
...
blogwings_companion_enqueue_google_font($elanzalite_body_font_h6);
$custom_css.="h6{ 
...
blogwings_companion_enqueue_google_font($elanzalite_body_font_a);
$custom_css.="a{ 
...
function blogwings_companion_magazina_customizers_enqueue(){
    echo "<style>";
   	echo  blogwings_companion_magazina_custom_style();
    echo "</style>";

}
add_action( 'wp_head', 'blogwings_companion_magazina_customizers_enqueue' );
